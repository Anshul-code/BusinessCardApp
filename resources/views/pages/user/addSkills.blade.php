...
<div class="row">
    <div class="col-lg-10 mx-auto">
        <div class="card card-dark">
            ...
            <div class="card-body">
                <form action="/addUserSkill" method="post">
                    @csrf
                        ...
                        <tbody>
                            ...
                            @foreach ($skills as $row)
                                <tr>
                                    ...
                                    <td>
                                        <form action="/deleteSkill/{{ $row->id }}" method="post">
                                            @csrf
                                            <a type="button" class="btn btn-success btn-sm" href="/editSkill/{{ $row->id }}"><i class="fas fa-edit"></i></a>
                                            {{ method_field("DELETE") }}
