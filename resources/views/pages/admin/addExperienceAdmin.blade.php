...
<div class="row">
    <div class="col-lg-12 mx-auto">
        <div class="card card-dark">
            ...
            <div class="card-body">
                <form action="/newExperienceAdminEdit/{{ $user_data->id }}" class="col-sm-8 mx-auto" method="post">
                    @csrf
...
<script>
 $('.data-table-experience').DataTable({
        processing: true,
        serverSide: true,
        ajax: "/getExperienceDataAdminEdit/{{ $user_data->id }}",
        columns: [
    ...
    $('#ok_button').click(function () {
        $.ajax({
            url: '/deleteExperienceDataAdminEdit/' + id ,
            beforeSend: function () {
