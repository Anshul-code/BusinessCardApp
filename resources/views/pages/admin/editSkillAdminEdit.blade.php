        ...
        <div class="card card-dark">
            <div class="card-header">
                ...
                <div class="float-right">
                    <a name="back" class="btn btn-light text-dark btn-sm" href="/addSkillsAdminEdit/{{ $user_data->id }}" role="button"><i class="fas fa-arrow-circle-left"></i> Back</a>
                </div>
            </div>
            <div class="card-body">
                <form action="/updateSkillAdminEdit/{{ $skill_info->id }}/{{ $user_data->id }}" method="post">
                    @csrf
                    {{ method_field("PUT") }}
