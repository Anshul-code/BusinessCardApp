...
<div class="row">
    <div class="col-lg-12 mx-auto">
        <div class="card card-dark">
            ...
            <div class="card-body">
                <form action="/newReferenceAdminEdit/{{ $user_data->id }}" method="post" class="col-sm-6 mx-auto" enctype="multipart/form-data">
                    @csrf
...
<script src="https://cdn.datatables.net/1.10.19/js/dataTables.bootstrap4.min.js"></script>
    ...
    $('.data-table-reference').DataTable({
        processing: true,
        serverSide: true,
        ajax: "/getReferenceInfoAdminEdit/{{ $user_data->id }}",
        columns: [
    ...
    $('#ok_button').click(function () {
        $.ajax({
            url: '/deleteReferenceDataAdminEdit/' + id,
            beforeSend: function () {
