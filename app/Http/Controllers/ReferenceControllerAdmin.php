...
class ReferenceControllerAdmin extends Controller
{
    public function getReferenceInfoAdminEdit(Request $request, $id){
        if ($request->ajax()) {
    ...
    public function deleteReferenceDataAdminEdit($id){
    ...
    public function newReferenceAdminEdit(Request $request, $id)
    {
        ...
        if ($request->hasFile('ref_image')) {
            ...
            return redirect('/addReferenceAdminEdit/'.$id)->with('success','Reference Added');
        }
    }
}
